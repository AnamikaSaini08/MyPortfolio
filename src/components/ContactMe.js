      ...
      <div className="flex my-32">
        ...
        <div className="ml-24">
          ...
          <div className="flex mt-11 justify-center">
            ...
            <button className=" bg-black text-white px-7 py-3  rounded-md font-sans hover:bg-slate-200 hover:text-gray-600 ease-in duration-200 hover:border-2 hover:border-gray-600 ">See My Resume</button>
            </div>
        </div>
      </div>
      <ContactDetails/>
