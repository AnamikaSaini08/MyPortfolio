    ...
    <div>
      ...
      <Fade left><img
        ...
        <div className="ml-52"><Fade right>
          ...
          <div className="flex flex-wrap mt-8 mb-16 sm:ml-28">
            <img
              alt="tailwind"
              className="max-h-16 max-w-16 mx-3 rounded-xl my-2"
            ...
            <img
              alt="nodejs"
              className="max-h-16 max-w-8 mx-3 rounded-xl my-2"
      ...
      <div className="flex mt-20">
       ...
       <div className="ml-52"> <Fade right>
          ...
          <div className="flex flex-wrap mt-8 mb-16 sm:ml-28">
            <img
              alt="c"
              className="h-16 w-16 mx-3 rounded-xl my-2"
