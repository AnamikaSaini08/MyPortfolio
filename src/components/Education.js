  ...
  return (
    <div>
      <div className='flex my-20'>
        ...
        <div className='w-1/2'>
            <img className='h-80 rounded-md shadow-lg' 
        ...
        <div>
            <h1 className='text-center text-5xl text-bold text-slate-800 font-sans'>Education</h1>
            <p className='my-10 text-bold text-slate-800 text-3xl'>Basic Qualification and Certifcations</p>
            <div className='flex mt-10 ml-28'>
                <a>
                    <img className='w-12 h-12 mx-2 rounded-md'
